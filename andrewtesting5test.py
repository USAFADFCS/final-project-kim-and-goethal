...
Use valid JSON values (strings, numbers) for arguments; do not include code like get_attacker_ip() – call the tool separately first if needed.
...
Only use "content" for final answers without tools. For multi-step tasks, use tools sequentially in the agentic loop. Be precise with arguments based on tool descriptions."""},
    ...
    for iteration in range(max_iterations):
        ...
        payload = {
            ...
            "tools": TOOLS,
            "max_tokens": 800,
            "temperature": 0.5,  # Increased for better adherence
        }
            ...
            if content.strip().startswith("{"):
                try:
                    ...
                    if "tool_calls" in parsed_content:
                        ...
                        print("Parsed tool_calls from content.")
