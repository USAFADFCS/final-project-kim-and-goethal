...
class QueryExpander:
    ...
    TERM_EXPANSIONS: Dict[str, List[str]] = {
        ...
        "sql injection": ["sqli", "sql", "union injection", "blind sqli", "error-based"],
        "union": ["union select", "sql union", "column count", "union injection"],
        "blind sqli": ["time-based", "boolean-based", "blind sql injection", "inferential"],
        ...
        # Injection attacks
        "injection": ["code injection", "command injection", "sql injection", "os injection"],
        "command injection": ["os injection", "shell injection", "rce", "code execution"],
        "rce": ["remote code execution", "code execution", "command injection", "shell"],
        "ssti": ["server-side template injection", "template injection", "jinja", "twig"],
    ...
    def _extract_terms(self, query: str) -> List[str]:
        ...
        for start, end, compound in reversed(found_compounds):
            masked_query = masked_query[:start] + " " * len(compound) + masked_query[end:]
