# PicoCTF Web Patterns and Strategies

> **Document Purpose:** Common patterns and strategies for PicoCTF-style web challenges. Designed for autonomous agent retrieval with pattern recognition and technique mapping.

---

## 1. General Style of PicoCTF Web Challenges

> **When to use this section:** Understanding PicoCTF challenge structure.

**Tags:** `picoctf, challenge-style, educational, patterns`
...
**Agent Takeaway:**
- PicoCTF challenges have clear intended solutions
- Challenge descriptions contain deliberate hints
- Start simple before trying complex exploits

---

## 2. "Robots / Crawlers / User-Agents" Pattern

> **When to use this section:** Challenge mentions robots, crawlers, or hidden pages.

### 2.1 How to Recognize It

**Tags:** `robots-txt, crawlers, hidden-paths, recognition`
...
**Tags:** `robots-recon, workflow, step-by-step`
...
**Tags:** `reasoning, example, robots-workflow`
...
> **When to use this section:** Challenge suggests looking at source code.

### 3.1 How to Recognize It

**Tags:** `view-source, html-comments, hidden-content, recognition`
...
**Tags:** `view-source-recon, workflow, html-inspection`
...
**Tags:** `reasoning, example, view-source-workflow`
...
**Tags:** `client-side, javascript, validation, recognition`
...
**Tags:** `javascript-recon, workflow, code-analysis`
...
**Tags:** `reasoning, example, javascript-workflow`
...
> **When to use this section:** Login behaves strangely or mentions databases.

### 5.1 How to Recognize It

**Tags:** `sqli, cookies, login-bypass, recognition`
...
**Tags:** `sqli-recon, cookie-recon, workflow`
...
- Reasoning:
  ...
  6. Attempt carefully crafted input to manipulate the logic (e.g., closing quotes and adding OR conditions).

---

### 5.4 Example Reasoning Path (Cookie Tampering Flavor)

**Tags:** `cookies, reasoning, example`
...
> **When to use this section:** Challenge mentions old versions or backup files.

### 6.1 How to Recognize It

**Tags:** `backups, old-files, hidden-content, recognition`
...
**Tags:** `backup-recon, workflow, enumeration`
...
**Tags:** `reasoning, example, backup-workflow`
...
**Tags:** `troubleshooting, stuck, checklist`
...
**Tags:** `mental-checklist, troubleshooting, basics`
...
**Tags:** `reasoning, troubleshooting, recovery`
...
## 8. Pattern → Technique Mapping

> **When to use this section:** Quick reference for pattern-based tool selection.

**Tags:** `pattern-mapping, technique-selection, quick-reference`

To make this document directly useful for an agent, here's a compact mapping:

| Pattern/Hint | Technique |
|--------------|-----------|
| "robots", "crawlers", "hidden from search engines" | Check `/robots.txt`, then visit disallowed paths |
| "view source", "look closer", very plain page | Fetch HTML, inspect comments, hidden inputs, linked files |
| "client-side", "JavaScript", "browser checks password" | Inspect scripts, reverse validation logic, send correct value directly |
| Strange login behavior, references to databases/queries | Test for SQLi, inspect responses for SQL errors, and/or check cookies for roles |
| References to old versions, backups, forgotten files | Check `robots.txt`, try likely backup/old paths, examine contents |
| Feeling stuck without clear direction | Run mental checklist: HTML source, `robots.txt`, JS logic, cookies, simple parameter variations |

---

## 9. Summary

**Tags:** `summary, picoctf, patterns, key-points`
...
**By linking hints in the description to typical web-exploitation techniques, an agent can:**
- Choose the right next step.
- Avoid random guessing.
- Follow a structured recon and reasoning path toward the flag.

**Agent Takeaway:**
- PicoCTF challenges are educational and hint-driven
- Match keywords in challenge descriptions to techniques
- Always try simple approaches before complex ones
- Use the pattern-technique mapping for quick decisions
