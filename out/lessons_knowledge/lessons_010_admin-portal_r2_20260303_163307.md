# Cookies / Session / Auth Bypass: When you achieve 'auth_bypassed' during a Cookies / Session / Auth Byp
...
**Applies when:** When you achieve 'auth_bypassed' during a Cookies / Session / Auth Bypass challenge

**Agent takeaway:** Continue exploitation after confirming 'auth_bypassed' — do not stop at reconnaissance
...
Do: Continue exploitation after confirming 'auth_bypassed' — do not stop at reconnaissance

Reason: The cookie_set tool was employed to change the user role to admin, exploiting the lack of server-side validation.
