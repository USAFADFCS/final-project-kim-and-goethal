...
class TestResponseDiffTool:
    ...
    def test_boolean_sqli_heuristic(self):
        ...
        response2 = "<html>" + "x" * 500 + "<p>User: admin</p><p>Email: admin@test.com</p></html>"
...
class TestResponseFingerprinter:
    ...
    def test_error_keyword_detection(self):
        ...
        result = self.tool.use(json.dumps({
            "response": "Error: SQL syntax error in query"
        }))
...
class TestDiffToolsCTFScenarios:
    ...
    def test_sqli_boolean_detection_scenario(self):
        ...
        result = self.diff_tool.use(json.dumps({
    ...
    def test_error_based_sqli_detection(self):
        ...
        result = self.diff_tool.use(json.dumps({
            "response1": normal_response,
            "response2": error_response
        }))
    ...
    def test_auth_bypass_detection(self):
        ...
        failed_login = "<html><body><p>Login failed. Please try again.</p></body></html>"
        successful_login = """
        <html><body>
        <h1>Welcome admin!</h1>
        ...
        result = self.diff_tool.use(json.dumps({
            "response1": failed_login,
            "response2": successful_login
        }))
