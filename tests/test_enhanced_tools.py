...
class TestDeserializationPayloadGeneratorEnhancements:
    ...
    def test_yaml_payloads_snakeyaml_section(self):
        ...
        assert "javax.script.ScriptEngineManager" in result or "java.lang.Runtime" in result
    ...
    def test_python_payloads_handcrafted_opcodes(self):
        ...
        assert "Handcrafted" in result or "handcrafted" in result or "opcodes" in result.lower()
